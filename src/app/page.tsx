...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Auto-select input content on focus for easier editing
...
function HomeScreen({
  ...
  onDuplicateWorkout: (w: Workout) => void;
  onViewHistory: () => void;
}) {
  return (
                ...
                >
                  ...
                  <div className="flex gap-1.5 ml-3 shrink-0">
                    <button
                      ...
                      className="px-2.5 py-2 rounded-lg bg-bg-secondary text-sm font-medium"
                    >
                      Edit
                    </button>
                    <button
                      onClick={() => onDuplicateWorkout(w)}
                      className="px-2 py-2 rounded-lg bg-bg-secondary text-gray-400"
                      title="Duplicate"
                    >
                      <CopyIcon />
                    </button>
                    <button
                      ...
                      className="px-2.5 py-2 rounded-lg bg-accent text-bg-primary text-sm font-bold"
                    >
                      Start
                    </button>
                    <button
